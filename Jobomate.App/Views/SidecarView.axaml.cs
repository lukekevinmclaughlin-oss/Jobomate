...
public partial class SidecarView : UserControl
{
    ...
    private Control BuildBrowser()
    {
        ...
        {
            Text = "The Jobomate LM Browser — the app's own built-in browser (no extension to install). Open a site, log in or solve any CAPTCHA yourself, then let your connected model take over to collect job postings — or companies for unsolicited applications. It never bypasses a login or CAPTCHA.",
